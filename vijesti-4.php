...
<header>
	...
	<main>
		...
		<div id="vijesti_gallery">
			<figure id="1">
				<img src="vijesti/vijesti-4.jpg" alt="Portugal" title="Sibir">
				<figcaption>Sibir<figcaption>
			</figure>
			<figure id="2">
				<img src="vijesti/vijesti-4-3.png" alt="Zastava Portugala" title="Zastava Rusije">
				<figcaption>Zastava Rusije<figcaption>
			</figure>
		</div>
		<hr>
		<div class="news">
			<h2>Rusija, Sibir</h2>
			<p class="description">Vodimo vas u veličanstveni Sibir</p>
			<p>Od sad pa nadalje s nama možete svaki prvi vikend do ožujka možete provesti u prelijepom Sibiru</p>
			<p>Pet noćenja za samo 3500 eura!</p>
			<p>Putovanje avionom</p>
			<p>Nije uključeno putno osiguranje!</p>
			<p>Za dodatna osiguranja potrebna je nadoplata!</p><br>
			<p><time datetime="2022.-12-22">22. prosinca 2022.</time></p><br>
